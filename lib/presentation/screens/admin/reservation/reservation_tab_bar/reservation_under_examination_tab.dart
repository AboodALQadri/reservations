...
class ReservationUnderExaminationTab extends StatelessWidget {
  const ReservationUnderExaminationTab({Key? key}) : super(key: key);
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return InkWell(
                        onTap: () {
                          Navigator.pushNamed(
                              context, reservationProductDetails,
                              arguments: myData);
                        },
